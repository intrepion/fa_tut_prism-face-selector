...
For this project, the code layer in this repo owns `default_face_selection_map`, `normalize_selection_rect`, and `assign_face_selection`, and adapter layer must not reimplement them.
