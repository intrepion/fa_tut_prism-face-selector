...
flutter create --platforms=web,android,ios,macos,windows,linux --org com.intrepion --project-name prism_face_selector workspace
git add --all
git commit --message "flutter create --platforms=web,android,ios,macos,windows,linux --org com.intrepion --project-name prism_face_selector workspace"
